...
$bookings = $connection->query("SELECT * FROM bookings");
$bookings->execute();
          ...
          <tbody>
            <?php foreach ($allBookings as $booking) : ?>
              <tr>
                ...
                <td><a href="change-status.php?id=<?php echo $booking->id; ?>" class="btn btn-warning text-center text-white">Update</a></td>
