...
$products = $connection->query("SELECT COUNT(*) AS count_products FROM products");
$products->execute();
$productsCount = $products->fetch(PDO::FETCH_OBJ);

$orders = $connection->query("SELECT COUNT(*) AS count_orders FROM orders");
$orders->execute();
$ordersCount = $orders->fetch(PDO::FETCH_OBJ);

$bookings = $connection->query("SELECT COUNT(*) AS count_bookings FROM bookings");
$bookings->execute();
$bookingsCount = $bookings->fetch(PDO::FETCH_OBJ);

$admins = $connection->query("SELECT COUNT(*) AS count_admins FROM admins");
$admins->execute();
