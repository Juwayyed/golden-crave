...
if (isset($_POST['submit'])) {
	if (empty($_POST['username']) or empty($_POST['email']) or empty($_POST['password'])) {
		...
		$insert = $connection->prepare("INSERT INTO users(username, email, password) VALUES (:username, :email, :password)");
		$insert->execute([
			":username" => $username,
			":email" => $email,
			":password" => $password
...
<section class="home-slider owl-carousel">
	...
	<div class="slider-item" style="background-image: url(<?php echo PRODUCTIMAGE; ?>bg_2.jpg);" data-stellar-background-ratio="0.5">
