...
$products = $connection->query("SELECT * FROM cart WHERE user_id='$_SESSION[user_id]'");
$products->execute();
        ...
        <div class="cart-total mb-3">
          ...
          <p class="d-flex">
            ...
            <?php if (count($allproducts) > 0) : ?>
              <span>$<?php echo $wholeCartTotal->total; ?></span>
            <?php else : ?>
              <span>$0.00</span>
            <?php endif; ?>
          </p>
          ...
          <p class="d-flex total-price">
            <span>Total</span>
            <?php if (count($allproducts) > 0) : ?>
              <span>$<?php echo $wholeCartTotal->total + 10 - 3; ?></span>
            <?php else : ?>
              <span>$0.00</span>
            <?php endif; ?>
          </p>
