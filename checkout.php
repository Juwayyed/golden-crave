...
<section class="home-slider owl-carousel">
	<div class="slider-item" style="background-image: url(<?php echo PRODUCTIMAGE; ?>bg_3.jpg);" data-stellar-background-ratio="0.5">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 ftco-animate">
				<form action="payment.php" method="POST" class="billing-form ftco-bg-dark p-3 p-md-5">
