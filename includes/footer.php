    ...
    <div class="row mb-5">
      <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
        <div class="ftco-footer-widget mb-4">
          ...
          <p>
            In the heart of every gathering, where rich coffee meets
            delicious bites and sweet moments are shared, we create a place
            where flavors, comfort, and good company come together
            effortlessly.
          </p>
          <ul
        ...
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-21 mb-4 d-flex">
            ...
            <div class="text">
              ...
              <div class="meta">
                <div>
                  <a href="#"><span class="icon-calendar"></span> Mar 25, 2026</a>
                </div>
                <div>
                  <a href="#"><span class="icon-person"></span> Admin</a>
                </div>
                <div>
                  <a href="#"><span class="icon-chat"></span> 12</a>
                </div>
              </div>
            </div>
          </div>
          <div class="block-21 mb-4 d-flex">
            ...
            <div class="text">
              ...
              <div class="meta">
                <div>
                  <a href="#"><span class="icon-calendar"></span> Mar 21, 2026</a>
                </div>
                <div>
                  <a href="#"><span class="icon-person"></span> Admin</a>
                </div>
      ...
      <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li>
                <span class="icon icon-map-marker"></span><span class="text">304 Santa Fe St. Mountain View, San Francisco,
                  California, USA</span>
              </li>
              <li>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <p>
          ...
          All rights reserved |
          <a href="https://Linkedin.com/in/Juwayyed" target="_blank">Juwayyed
          </a>
        </p>
      </div>
    </div>
