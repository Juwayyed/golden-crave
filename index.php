      ...
      <div
        ...
        <div class="col-md-8 col-sm-12 text-center ftco-animate">
          ...
          <p class="mb-4 mb-md-5">
            The finest coffee beans are carefully selected and brewed to
            create the perfect balance of aroma, flavor, and warmth for an
    ...
    <div class="container">
      <div
        ...
        <div class="col-md-8 col-sm-12 text-center ftco-animate">
          ...
          <p class="mb-4 mb-md-5">
            Delicious flavors meet a stunning setting, creating the perfect
            combination of taste and ambiance for every memorable visit.
          </p>
          <p>
            <a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a>
            <a
  ...
  <div class="slider-item" style="background-image: url(<?php echo PRODUCTIMAGE; ?>bg_3.jpg)">
    ...
    <div class="container">
      <div
        ...
        <div class="col-md-8 col-sm-12 text-center ftco-animate">
          <span class="subheading">Welcome</span>
          <h1 class="mb-4">Creamy Hot Drinks and Ready to be Served</h1>
          <p class="mb-4 mb-md-5">
            Warm and creamy drinks, prepared with care and served fresh to
            delight your senses and brighten every cozy moment.
          </p>
          <p>
            <a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a>
            <a
      ...
      <div class="info">
        <div class="row no-gutters">
          ...
          <div class="col-md-4 d-flex ftco-animate">
            ...
            <div class="text">
              <h3>304 Santa Fe St.</h3>
              <p>Mountain View, San Francisco, California, USA</p>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">
      ...
      <div class="col-md-4 ftco-animate">
        <div class="media d-block text-center block-6 services">
          ...
          <div class="media-body">
            ...
            <p>
              Ordering is simple and fast, designed to save time while
              letting you enjoy your favorite meals with ease.
            </p>
          </div>
        </div>
      </div>
      <div class="col-md-4 ftco-animate">
        <div class="media d-block text-center block-6 services">
          ...
          <div class="media-body">
            ...
            <p>
              Our delivery is quick and reliable, ensuring your favorite
              dishes and drinks arrive hot and fresh every time.
            </p>
          </div>
        </div>
      </div>
      <div class="col-md-4 ftco-animate">
        <div class="media d-block text-center block-6 services">
          ...
          <div class="media-body">
            ...
            <p>
              Our coffee is carefully selected and brewed to deliver rich
              flavors and a perfect cup every time.
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-5 pb-3">
      <div class="col-md-7 heading-section ftco-animate text-center">
        ...
        <p>
          Far far away, behind the coffee beans and roasting machines, our
          best sellers delight with rich flavors, smooth aromas, and cups
          made to perfection.
        </p>
      </div>
    </div>
