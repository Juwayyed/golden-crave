...
<?php
$hotProducts = $connection->query("SELECT * FROM products WHERE category = 'Hot_Drinks'");
$hotProducts->execute();
$allHotProducts = $hotProducts->fetchAll(PDO::FETCH_OBJ);

$coldProducts = $connection->query("SELECT * FROM products WHERE category = 'Fresh_Drinks'");
$coldProducts->execute();
$allColdProducts = $coldProducts->fetchAll(PDO::FETCH_OBJ);

$dishes = $connection->query("SELECT * FROM products WHERE category = 'Dishes'");
$dishes->execute();
$allDishes = $dishes->fetchAll(PDO::FETCH_OBJ);

$desserts = $connection->query("SELECT * FROM products WHERE category = 'Desserts'");
$desserts->execute();
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        ...
        <?php foreach ($allDishes as $dishes) : ?>
      ...
      <div class="col-md-6">
        ...
        <?php foreach ($allColdProducts as $coldProducts) : ?>
          <div class="pricing-entry d-flex ftco-animate">
            <div
              class="img"
            ...
            <div class="desc pl-3">
              <div class="d-flex text align-items-center">
                ...
                <span class="price">$<?php echo $coldProducts->price; ?></span>
              </div>
              <div class="d-block">
                <p>
                  <?php echo $coldProducts->description; ?>
                </p>
              </div>
            </div>
          </div>
                    ...
                    <div class="col-md-4 text-center">
                      <div class="menu-wrap">
                        ...
                        <div class="text">
                          ...
                          <p class="price"><span>$<?php echo $coldProducts->price; ?></span></p>
                          <p>
                            <a
                              href="products/product-details.php?id=<?php echo $coldProducts->id; ?>"
